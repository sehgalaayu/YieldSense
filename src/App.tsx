...
const CompareInstrumentsPage = lazy(
  () => import("./pages/CompareInstrumentsPage"),
);
  ...
  return (
    <Router>
      ...
      <div className="min-h-screen bg-bg-primary text-text-primary flex flex-col font-sans">
        <Navbar />
        <PWAInstallBanner />
        <main className="flex-grow pb-[calc(72px+env(safe-area-inset-bottom))] md:pb-0">
          <Suspense
            fallback={
          ...
          <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
            <div className="flex flex-col gap-2">
              ...
              <p className="text-text-muted text-sm italic">
                Invest in FDs. Understand what you earn.
              </p>
            </div>
            ...
            <div className="text-right flex flex-col items-end gap-1">
              <p className="text-xs text-text-muted">
                Backed by Blostem Infrastructure · Made by{" "}
                <a
              ...
              <div className="text-xs text-[#1E3A5F] flex items-center justify-end gap-2">
                <span>
                  Built for Blostem Hackathon 2026 · © 2026 WealthSense
                </span>
                <span>·</span>
                <a
                  href="https://github.com/sehgalaayu/YieldSense"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="hover:text-accent-gold transition-colors underline object-contain"
                >
                  GitHub
                </a>
              </div>
