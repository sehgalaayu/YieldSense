    ...
    <div className="relative overflow-hidden">
            ...
            <div style={{ overflow: "visible" }}>
              ...
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-[#1E3A5F] bg-[#0D1A2E] mb-6 animate-fade-in-up">
                ...
                <span className="text-xs font-mono text-[#64748B] uppercase tracking-widest">
                  {language === "hi"
                    ? "लाइव FD इंटेलिजेंस · भारत"
                    : "Live FD Intelligence · India"}
                </span>
              </div>
            ...
            <div className="relative isolate animate-fade-in-up-delay-3 max-w-[420px] ml-auto w-full">
              ...
              >
                ...
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-[10px] font-mono bg-[#112240] text-[#3B82F6] px-2 py-1 rounded border border-[#1E3A5F]">
                    BETA 2026
                  </span>
                </div>
                ...
                <div className="flex gap-2 mb-4 p-1 bg-[#0A0F1E] rounded-lg border border-[#1E3A5F]">
                  <button
                    ...
                    className={`flex-1 py-1.5 text-xs font-semibold rounded ${activeTab === "fds" ? "bg-[#1A56DB] text-white" : "text-[#64748B] hover:text-[#94A3B8]"}`}
                  >
                    FDs
                  </button>
                  <button
                    onClick={() => setActiveTab("mf")}
                    className={`flex-1 py-1.5 text-xs font-semibold rounded ${activeTab === "mf" ? "bg-[#1A56DB] text-white" : "text-[#64748B] hover:text-[#94A3B8]"}`}
                  >
                    Mutual Funds
                  </button>
                </div>
                ...
                {activeTab === "fds" ? (
                    ...
                    {loading ? (
                      ...
                      <>
                          ...
                          <div className="rounded-lg border border-[#F59E0B]/30 bg-[#F59E0B]/5 p-3 mb-2 relative overflow-hidden">
                            ...
                            <div className="flex justify-between items-start relative z-10">
                              ...
                              <div className="text-right">
                                <p className="text-[#F1F5F9] font-mono font-bold text-lg">
                                  {topFDs[0].rate}%
                                </p>
                                <p className="text-[#F59E0B] text-xs font-mono">
                                  {language === "hi" ? "टैक्स बाद" : "Post-Tax"}
                                  : {topFDs[0].postTaxYield}%
                                </p>
                              </div>
                            </div>
                          </div>
                        ...
                        {topFDs.slice(1).map((fd, i) => (
                          <div
                            key={i}
                            className="rounded-lg bg-[#112240] p-3 mb-2"
                          >
                            <div className="flex justify-between items-start">
                              ...
                              <div className="text-right">
                                <p className="text-[#94A3B8] font-mono font-semibold">
                                  {fd.rate}%
                                </p>
                        ...
                        <div className="mt-3 flex items-start gap-2 p-3 rounded-lg bg-[#0A0F1E] border border-[#1E3A5F]">
                          <div className="w-6 h-6 rounded-full bg-[#1A56DB] flex items-center justify-center flex-shrink-0 text-xs text-white font-bold">
                            AI
                          </div>
                  ...
                  <>
                    ...
                    {[
                      ...
                      <div
                        key={i}
                        className="rounded-lg bg-[#112240] p-3 mb-2 border border-[#1E3A5F]/50"
                      >
                        ...
                        <div className="mt-2 text-right">
                          <p className="text-[#10B981] text-xs font-semibold">
                            {language === "hi"
                              ? `डायरेक्ट में स्विच करें: बचाएं ${mf.save}`
                              : `Switch to Direct: save ${mf.save}`}
                          </p>
                        </div>
                      </div>
                    ))}
                ...
                <div className="mt-3 flex items-center justify-between">
                  <span className="text-[9px] font-mono text-[#1E3A5F] uppercase">
                    Updated · Apr 2026
                  </span>
                  <button
                    onClick={() => navigate("/compare")}
                    className="text-[10px] text-[#1A56DB] hover:text-[#3B82F6] font-mono transition-colors"
                  >
                    {language === "hi"
                      ? "सभी 34+ FDs देखें →"
                      : "View all 34+ FDs →"}
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-[#1E3A5F] reveal">
          {[
            ...
            return (
              <div
                key={i}
                className={`px-8 py-4 md:py-0 text-center reveal ${delayClasses[i % 3]}`}
              >
                <p className="font-mono font-bold text-3xl text-[#1A56DB]">
                  {stat.value}
                </p>
        ...
        <div className="max-w-6xl mx-auto">
            ...
            <div className="reveal reveal-delay-1">
              ...
              <div className="flex gap-3 mt-4">
                {[
                  "Hindi",
                  "English",
                  language === "hi" ? "सरल भाषा" : "Jargon-free",
                ].map((tag) => (
                  <span
                    key={tag}
                    className="px-3 py-1 text-xs rounded-full border border-[#1E3A5F] text-[#64748B]"
                  >
                    {tag}
                  </span>
                ))}
            ...
            <div className="rounded-xl border border-[#1E3A5F] bg-[#0D1A2E] p-4 reveal reveal-delay-2">
              <div className="space-y-3">
                ...
                <div className="flex gap-2">
                  <div className="w-6 h-6 rounded-full bg-[#1A56DB] flex items-center justify-center text-xs text-white flex-shrink-0">
                    AI
                  </div>
                  <div className="bg-[#112240] border-l-2 border-[#1A56DB] text-[#94A3B8] text-sm px-3 py-2 rounded-lg rounded-tl-sm max-w-[80%]">
                    हाँ! Suryoday DICGC insured है — मतलब ₹5 लाख तक आपका पैसा
                    100% safe है। यह RBI-regulated Small Finance Bank है।
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center py-16 border-b border-[#1E3A5F] reveal">
            ...
            <div className="rounded-xl border border-[#1E3A5F] bg-[#0D1A2E] p-5 order-2 md:order-1 reveal reveal-delay-1">
              <p className="text-xs font-mono text-[#64748B] uppercase mb-3">
                ₹1,00,000 · 12M · 30% Tax Slab
              </p>
              <div className="space-y-2">
                <div className="flex justify-between">
                  <span className="text-[#64748B] text-sm">
                    {language === "hi" ? "सकल परिपक्वता" : "Gross Maturity"}
                  </span>
                  <span className="font-mono text-[#F1F5F9]">₹1,07,500</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-[#64748B] text-sm">
                    {language === "hi" ? "TDS कटौती" : "TDS Deducted"}
                  </span>
                  <span className="font-mono text-red-400">-₹750</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-[#64748B] text-sm">
                    {language === "hi" ? "स्लैब टैक्स" : "Slab Tax"}
                  </span>
                ...
                <div className="border-t border-[#1E3A5F] pt-2 flex justify-between">
                  <span className="text-[#F1F5F9] font-medium text-sm">
                    {language === "hi" ? "नेट परिपक्वता" : "Net Maturity"}
                  </span>
                  <span className="font-mono font-bold text-[#F59E0B] text-lg">
                    ₹1,05,250
                  </span>
                </div>
              </div>
              ...
              <div className="mt-4 space-y-2">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[#64748B] text-xs">
                    {language === "hi"
                      ? "DICGC बीमित — SBI, HDFC, Suryoday SFB और सभी अनुसूचित बैंक"
                      : "DICGC Insured — SBI, HDFC, Suryoday SFB and all scheduled banks"}
                  </span>
                </div>
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[#64748B] text-xs">
                    {language === "hi"
                      ? "बीमित नहीं — Bajaj Finance, Shriram Finance (NBFCs)"
                      : "Not Insured — Bajaj Finance, Shriram Finance (NBFCs)"}
                  </span>
                </div>
              </div>
            </div>
              ...
              {[
                ...
                >
                  ...
                  <div className="flex items-center gap-3">
                    <span className="font-mono text-[#F1F5F9] text-sm">
                      {item.rate}
                    </span>
                    {item.insured ? (
                      ...
                      <span className="text-xs bg-red-900/30 text-red-400 border border-red-800/50 px-2 py-0.5 rounded-full">
                        {language === "hi" ? "बीमित नहीं" : "Not Insured"}
                      </span>
                    )}
                  </div>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center py-16 reveal">
            ...
            <div className="order-1 md:order-2 reveal reveal-delay-2">
              ...
              <button
                onClick={() => navigate("/mf")}
                className="mt-4 text-accent-blue text-xs font-bold uppercase tracking-widest flex items-center gap-1 hover:gap-2 transition-all"
              >
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 reveal">
            {[
              {
                quote:
                  "Suryoday ka FD choose kiya YieldSense ki wajah se — ₹12,000 zyada milenge!",
                name: "Priya K.",
              ...
              {
                quote:
                  "Finally understood what TDS meant for my dad's savings. The Hindi support is incredible.",
                name: "Aman S.",
                location: "New Delhi",
                highlight: false,
              },
              {
                quote:
                  "The comparison table is a game changer. All I need is 2 mins to find the best yield.",
                name: "Rajesh T.",
                location: "Bangalore",
                highlight: false,
              },
              {
                quote:
                  "Mere tax slab ke hisaab se best FD batata hai — koi dusra app yeh nahi karta.",
                name: "Sunita V.",
              ...
              {
                quote:
                  "DICGC coverage indicator saved me from putting ₹8L in an uninsured NBFC.",
                name: "Karthik M.",
                location: "Chennai",
                highlight: false,
              },
              {
                quote:
                  "Built for real India. Not just English-speaking metro users.",
                name: "Deepa R.",
              ...
              return (
                <div
                  key={i}
                  className={`rounded-xl border p-5 transition-all hover:scale-[1.02] ${testimonial.highlight ? "border-[#F59E0B]/40 bg-[#F59E0B]/5" : "border-[#1E3A5F] bg-[#0A0F1E]"} reveal ${delayClasses[i % 3]}`}
                >
      ...
      <section className="relative py-24 px-6 bg-[#0A0F1E]">
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse 60% 50% at 50% 50%, rgba(26,86,219,0.1) 0%, transparent 70%)",
          }}
        />
        <div className="relative z-10 text-center max-w-2xl mx-auto">
          <p className="text-xs font-mono text-[#1A56DB] uppercase tracking-widest mb-4 reveal">
            {language === "hi"
              ? "स्मार्ट निवेश के लिए तैयार?"
          ...
          >
            {language === "hi"
              ? "2 मिनट में अपना सबसे अच्छा FD खोजें।"
              : "Find your best FD in 2 minutes."}
          </h2>
          ...
          <p className="text-[#64748B] text-xs mt-4 reveal reveal-delay-4">
            {language === "hi"
              ? "कोई साइनअप नहीं। कोई बैंक क्रेडेंशियल नहीं चाहिए।"
              : "No signup required. No bank credentials needed."}
          </p>
        </div>
      </section>
    </div>
