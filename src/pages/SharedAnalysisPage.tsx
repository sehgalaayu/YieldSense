...
import { AlertCircle, TrendingUp, Wallet, ShieldCheck, ArrowLeft, Loader2 } from 'lucide-react';
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-[#0A0F1E] flex flex-col items-center justify-center p-6">
        ...
        <p className="text-[#64748B] font-syne font-bold animate-pulse">Decrypting Analysis Snapshot...</p>
      </div>
    );
  }
  ...
  if (error) {
    return (
      <div className="min-h-screen bg-[#0A0F1E] flex flex-col items-center justify-center p-6 text-center">
        ...
        <h1 className="text-2xl font-syne font-bold text-[#F1F5F9] mb-2">Link Invalid</h1>
    ...
    <div className="min-h-screen bg-[#0A0F1E] text-[#F1F5F9] pb-20">
      ...
      <div className="max-w-4xl mx-auto px-6 mt-8">
        ...
        >
          ...
          <span className="text-sm font-bold uppercase tracking-widest">Back to WealthSense</span>
        </button>

        <header className="mb-10 text-center">
          <h1 className="text-3xl sm:text-5xl font-syne font-black mb-4 leading-tight">
            Portfolio <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent-blue to-accent-gold">Analysis Report</span>
          </h1>
          <p className="text-[#64748B] max-w-2xl mx-auto">
            This snapshot shows how switching to Direct Mutual Fund plans could optimize this portfolio.
          </p>
        </header>
        ...
        >
          <div className="absolute top-0 left-0 w-full h-2" style={{ backgroundColor: score.gradeColor }} />
          ...
          <div className="flex flex-col md:flex-row items-center gap-10">
            <div className="relative w-40 h-40 flex-shrink-0">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center">
                  <span className="font-mono font-black text-5xl" style={{ color: score.gradeColor }}>
                    {score.totalScore}
                  </span>
                  <span className="text-xs text-[#64748B] font-bold uppercase tracking-tighter">Score</span>
                </div>
            </div>

            <div className="flex-1 text-center md:text-left">
                <div className="inline-block px-4 py-1 rounded-full mb-4 border border-[#1E3A5F] bg-[#112240]" style={{ color: score.gradeColor }}>
                    <span className="text-sm font-black uppercase tracking-widest">Grade {score.grade} Portfolio</span>
                </div>
                <h2 className="text-2xl font-bold mb-4">
                  Potential 10-Year Savings: <span className="text-green-400">₹{total10YSaving.toLocaleString('en-IN')}</span>
                </h2>
                <div className="space-y-2">
                    {score.insights.slice(0, 2).map((insight: string, i: number) => (
                        <div key={i} className="flex items-start gap-3 justify-center md:justify-start">
                            <ShieldCheck className="text-accent-gold flex-shrink-0 mt-0.5" size={16} />
                            <p className="text-[#94A3B8] text-sm leading-relaxed">{insight}</p>
                        </div>
                    ))}
                </div>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
            <div className="bg-[#112240] border border-[#1E3A5F] p-6 rounded-2xl">
                <div className="flex items-center gap-3 mb-4">
                    ...
                    <h3 className="font-bold uppercase tracking-wider text-sm">Wealth Gain Impact</h3>
                </div>
                <p className="text-[#94A3B8] text-sm leading-relaxed mb-4">
                    By eliminating high commissions (up to 1.5% p.a.), this portfolio can compound significantly faster. 
                </p>
            ...
            <div className="bg-[#112240] border border-[#1E3A5F] p-6 rounded-2xl">
                <div className="flex items-center gap-3 mb-4">
                    ...
                    <h3 className="font-bold uppercase tracking-wider text-sm">Transparency Check</h3>
                </div>
                <p className="text-[#94A3B8] text-sm leading-relaxed mb-4">
                    Direct plans have the same underlying assets as regular plans but zero distributor commission.
                </p>
        ...
        <div className="bg-gradient-to-br from-[#112240] to-[#0A0F1E] border border-[#1E3A5F] p-10 rounded-3xl text-center shadow-2xl relative overflow-hidden">
            ...
            <h3 className="text-2xl font-syne font-bold mb-4 relative z-10">Check Your Own Portfolio Performance</h3>
            <p className="text-[#64748B] mb-8 max-w-md mx-auto relative z-10">
                Join 10,000+ investors who use WealthSense to detect hidden commissions and switch to Direct plans.
            </p>
            <button 
                onClick={() => navigate('/mf')}
