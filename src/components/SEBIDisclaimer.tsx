...
export const SEBIBanner = () => (
  <div className="flex items-start gap-3 p-3 rounded-lg bg-amber-950/20 border border-amber-800/30 mb-4">
    <span className="text-amber-400 text-sm flex-shrink-0">⚠️</span>
    <p className="text-xs text-amber-200/70 leading-relaxed">
      <strong className="text-amber-300">Investment Disclaimer:</strong> WealthSense 
      is not a SEBI-registered investment advisor. All information is for 
